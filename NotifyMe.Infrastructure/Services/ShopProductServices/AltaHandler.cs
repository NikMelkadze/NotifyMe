...
public class AltaHandler(
    IHttpClientService httpClientService,
    IOptionsMonitor<JwtTokensOption> tokensOption) : ShopHandlerBase(httpClientService, null)
{
    ...
    {
        var content = await _httpClientService.GetProductJson(url, _tokensOption.Alta, cancellationToken);
